...
source_video_path = "media_files/kayit2.mp4"
video_saving_path = source_video_path[:len(source_video_path)-4:]+"_output.mp4"


model = torch.hub.load('ultralytics/yolov5', "custom",'/Users/xalil/Desktop/tez/weights/tez.pt',force_reload=False,device="mps")
...
########################TRACKER###########################
tracker_list = []
tracker = create_tracker('bytetrack', "/Users/xalil/Desktop/tez/app/trackers/bytetrack/configs/bytetrack.yaml", "weights/osnet_x0_25_msmt17.pt", device=torch.device("mps"),half =False)
